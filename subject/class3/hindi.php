...
<div class="tabs-container">
    ...
    <div class="content-container">
      <div class="content active">
        ...
        while($row_1 = mysqli_fetch_array($result37)) { ?>
    ...
    <?php } ?>
      ...
      <div class="content">
        ...
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result38)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
      </div>
      ...
      <div class="content">
        <div class="up_page"><?php 
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result39)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
      </div>
      ...
      <div class="content">
        <div class="up_page"><?php 
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result40)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
        </p>
