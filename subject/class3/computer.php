        ...
        <div class="container">
            ...
            <div id="mainListDiv" class="main_list">
                <ul class="navlinks">
                    ...
                    <li><a href="../../class/class3.html">Back</a></li>
...
<div class="tabs-container">
    ...
    <div class="content-container">
      <div class="content active">
        ...
        while($row_1 = mysqli_fetch_array($result45)) { ?>
    ...
    <?php } ?>
      ...
      <div class="content">
        ...
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result46)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
      </div>
      ...
      <div class="content">
        <div class="up_page"><?php 
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result47)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
      </div>
      ...
      <div class="content">
        <div class="up_page"><?php 
        include_once(dirname(__FILE__).'/../disp.php');
        while($row_1 = mysqli_fetch_array($result48)) { ?>
      <p>        <a href="../../upload/<?php echo $row_1['file_name'] ?>" download><?php echo $row_1['file_name'] ?></a>
</p>
    <?php } ?></div>
        </p>
